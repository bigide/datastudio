...
export default {
  ...
  'rc.cc.sqlSubmitJarPathHelp':
    '请输入 Jar 文件路径! eg: hdfs:///dinky/datastudio-app-1.16-with-dependencies.jar',
  'rc.cc.sqlSubmitJarPathHelpTips':
    'Yarn 模式下此参数可以设置为: hdfs:///dinky/datastudio-app-1.17-with-dependencies.jar 或者 rs:/dinky/datastudio-app-1.17-with-dependencies.jar 如果设置为 rs:/ 协议,则需要将该jar包上传到 Dinky 的资源中心中,然后填写该路径。K8s 模式下仅支持 local:// 协议',
